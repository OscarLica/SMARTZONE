<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="ArticulosTaller.aspx.cs" Inherits="Interface.ArticulosTaller" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="Script/jquery-3.5.1.js"></script>
   <script>
       const Onload = async () => {
           const url = "MainProductos.aspx/CargarProductosTaller";
           ...
           response.d.forEach((productos) => {
               ...
               btnView.type = "button";
               btnView.onclick = () => {
                   location = "./MainProductosTaller.aspx?IdProducto=" + productos.Id;
               }
       ...
       const BuscarProducto = async () => {
           ...
           const url = "ArticulosTaller.aspx/BuscarProductoxNombre";
           let response = await fetch(
               url, {
               method: "POST",
